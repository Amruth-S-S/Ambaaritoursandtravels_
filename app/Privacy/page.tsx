...
export const metadata = {
  ...
  description:
    'Ambaari Tours and Travels Privacy Policy – Learn how we collect, use, and protect your personal information.',
};
...
const sections = [
  {
    ...
    content: (
      <>
        <p className="pp-subsection">Personal Information</p>
        ...
        <ul className="pp-list">
          ...
          <li>Information submitted via contact forms, booking forms, or newsletter sign-ups</li>
        </ul>
        <p className="pp-subsection">Automatically Collected Information</p>
        <p className="pp-text">When you visit our website, we may automatically collect:</p>
        <ul className="pp-list">
  ...
  },
  {
    ...
    content: (
      <ul className="pp-list">
        ...
        <li>Share updates about tours, offers, and travel packages</li>
        <li>Improve website performance and user experience</li>
        <li>Send promotional emails or newsletters (with your consent only)</li>
  ...
  },
  {
    ...
    content: (
      <p className="pp-text">
        We use cookies and similar technologies to analyze website traffic and user behavior, improve
        functionality, and personalize your browsing experience. You can disable cookies through your
  ...
  },
  {
    ...
    content: (
      <>
        <p className="pp-text">We do not sell, trade, or rent your personal information. We may share your data with:</p>
        <ul className="pp-list">
          <li>Trusted service providers (payment processors, booking partners)</li>
          <li>Legal authorities if required by law</li>
          <li>Third parties to protect our rights and prevent fraud</li>
        </ul>
        <p className="pp-text">All partners are required to keep your information confidential.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <p className="pp-text">
        Our website may include links to third-party websites or use external tools such as analytics
        and payment gateways. These services have their own privacy policies, and we are not
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-black to-gray-900 text-gray-200">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 md:py-16">
        ...
        <div className="space-y-5">
          {sections.map(({ num, title, content }) => (
            ...
            >
              ...
              {/* Section body */}
              <div className="px-6 py-5 [&_.pp-text]:text-sm [&_.pp-text]:text-gray-300 [&_.pp-text]:leading-[1.75] [&_.pp-text]:mb-3 [&_.pp-subsection]:text-xs [&_.pp-subsection]:font-semibold [&_.pp-subsection]:uppercase [&_.pp-subsection]:tracking-wider [&_.pp-subsection]:text-yellow-500 [&_.pp-subsection]:mt-3 [&_.pp-subsection]:mb-1.5 [&_.pp-list]:flex [&_.pp-list]:flex-col [&_.pp-list]:gap-1.5 [&_.pp-list]:mb-3 [&_.pp-list_li]:text-sm [&_.pp-list_li]:text-gray-300 [&_.pp-list_li]:leading-relaxed [&_.pp-list_li]:pl-5 [&_.pp-list_li]:relative before:[&_.pp-list_li]:content-[''] before:[&_.pp-list_li]:absolute before:[&_.pp-list_li]:left-0 before:[&_.pp-list_li]:top-[9px] before:[&_.pp-list_li]:w-1.5 before:[&_.pp-list_li]:h-1.5 before:[&_.pp-list_li]:rounded-full before:[&_.pp-list_li]:bg-yellow-500/70">
                {content}
              </div>
            </div>
          ))}
        ...
        {/* Footer note */}
        <div className="mt-8 rounded-xl border border-yellow-500/15 bg-yellow-500/5 px-5 py-4 text-center">
          <p className="text-xs text-gray-500">
            Website:{' '}
            <span className="font-mono text-yellow-500">https://ambaaritoursandtravels.com</span>
          </p>
          <p className="text-xs text-gray-600 mt-1">
            &copy; {new Date().getFullYear()} Ambaari Tours and Travels. All rights reserved.
          </p>
        </div>
      </main>
    </div>
